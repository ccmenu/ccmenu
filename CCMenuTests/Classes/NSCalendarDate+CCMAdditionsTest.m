...
@interface NSCalendarDate_CCMAdditionsTest : XCTestCase
{
...
- (void)testDescribesTimeSinceLastBuildWhenAMinuteOrLess
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"less than a minute ago", @"Should have returned time in minutes.");
}
...
- (void)testDescribesTimeSinceLastBuildAsOneMinute
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"a minute ago", @"Should have returned time in minutes.");
}
...
- (void)testDescribesTimeSinceLastBuildInMinutes
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"2 minutes ago", @"Should have returned time in minutes.");
}
...
- (void)testDescribesTimeSinceLastBuildAsOneHour
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"an hour ago", @"Should have returned time in hours.");
}
...
- (void)testDescribesTimeSinceLastBuildInHours
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"2 hours ago", @"Should have returned time in hours.");
}
...
- (void)testDescribesTimeSinceLastBuildAsOneDay
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"1 day ago", @"Should have returned time in days.");
}
...
- (void)testDescribesTimeSinceLastBuildInDays
{
	...
	XCTAssertEqualObjects([reference relativeDescriptionOfPastDate:date], @"2 days ago", @"Should have returned time in days.");
}
...
{
	NSCalendarDate *date = [reference dateByAddingYears:0 months:0 days:0 hours:0 minutes:0 seconds:59];
	XCTAssertEqualObjects([date descriptionOfIntervalWithDate:reference], @"59s", @"Should have returned time in seconds.");
}
...
- (void)testDescribesLessThan60minuteIntervalInMinutesAndSeconds
{
	...
	XCTAssertEqualObjects([date descriptionOfIntervalWithDate:reference], @"59:09", @"Should have returned time in minutes and seconds.");
}
...
- (void)testDescribesMoreThan60minuteIntervalInHoursMinutesAndSeconds
{
	...
	XCTAssertEqualObjects([date descriptionOfIntervalWithDate:reference], @"24:08:09", @"Should have returned time in hours, minutes, seconds.");
}
...
{
	NSCalendarDate *date = [reference dateByAddingYears:0 months:0 days:0 hours:0 minutes:0 seconds:59];
	XCTAssertEqualObjects([date descriptionOfIntervalSinceDate:reference withSign:YES], @"+59s", @"Should have returned time with plus sign.");
}

- (void)testDescribesLessThan60sReverseIntervalSecondsWithMinusSign
{
	NSCalendarDate *date = [reference dateByAddingYears:0 months:0 days:0 hours:0 minutes:0 seconds:-59];
	XCTAssertEqualObjects([date descriptionOfIntervalSinceDate:reference withSign:YES], @"-59s", @"Should have returned time with minus sign.");
}

- (void)testDescribesReverseLessThan60minuteIntervalInMinutesAndSecondsWithMinusSign
{
	NSCalendarDate *date = [reference dateByAddingYears:0 months:0 days:0 hours:0 minutes:-59 seconds:-9];
	XCTAssertEqualObjects([date descriptionOfIntervalSinceDate:reference withSign:YES], @"-59:09", @"Should have returned time with one minus sign in front.");
}

- (void)testDescribesZeroLengthIntervalWithEmptyString
{
	XCTAssertEqualObjects([reference descriptionOfIntervalSinceDate:reference withSign:YES], @"", @"Should have returned empty string.");
}
